...
<!--the diagram title for rent-->
	<br>
	<div class="select_house_type" style="display: none">
		<span style="font-size: 15px"> Select the type of the property you want to rent</span>
	</div>
	...
	<div class="svg3" style="display: none">
	</div>
<!--buy part-->

		<div id="drop2" style="display: none"></div>
		<br>
